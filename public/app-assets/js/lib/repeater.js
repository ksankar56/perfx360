...
$(document).ready(function () {
    ...
    $(document.body).on('change', '.auth-mode-select', function() {
        ...
        if ($(this).val() == 'basicAuth') {
            $('#scenario' + currentScenario + 'AuthDetails' + currentItem).css("display", "block");
        } else {
