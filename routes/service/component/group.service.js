...
exports.saveGroup = function(req, res, next) {
    ...
    if (_.isEmpty(groupJson)) {
        var baseError = new BaseError(Utils.buildErrorResponse(constants.GROUP_OBJ_EMPTY, '', constants.GROUP_DUPLICATE_MSG, err.message, 500));
...
exports.updateGroup = function(req, res, next) {
    Group.findById(req.body.id, function (err, group) {
        ...
        if (err) {
            ...
            group.component = req.body.component || group.component;
